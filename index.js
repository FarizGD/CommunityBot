(async () => {
  ...
  console.log(chalk.green.bold(`
    --------------------------------------
    ☘️ Selamat datang di CommunityBot
  ...
  console.log(chalk.white.bold("  | GitHub: ") + chalk.cyan.bold("https://github.com/FarizGD/CommunityBot"));
  console.log(chalk.white.bold("  | Developer: ") + chalk.green.bold("CommunityBot Community"));
