...
module.exports = {
  ...
  async run(m, { sock, plugins, config, Func, text }) {
    ...
    let pp = await sock
      ...
      .catch((e) => "https://files.catbox.moe/58x9zu.jpg");
    ...
    const header = `☘️ *CommunityBot*
👋 Hello, im CommunityBot. Saya adalah asisten bot WhatsApp 
...
💻 *Script bot:* https://github.com/FarizGD/CommunityBot
      ...
      m.reply({
        ...
        contextInfo: {
          ...
          externalAdReply: {
            ...
            body: "One for all",
            mediaType: 1,
            sourceUrl: "https://github.com/FarizGD/CommunityBot",
            thumbnailUrl: "https://files.catbox.moe/b2jw69.png",
...
`;
      ...
      m.reply({
        ...
        contextInfo: {
          mentionedJid: sock.parseMention(caption),
          externalAdReply: {
            title: "© CommunityBot - Dari kita untuk kita",
            body: "👨‍💻 Bot WhatsApp",
            mediaType: 1,
            sourceUrl: "https://github.com/FarizGD/CommunityBot",
            thumbnailUrl: "https://files.catbox.moe/b2jw69.png",
